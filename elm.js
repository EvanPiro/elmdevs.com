...
var $author$project$Page$footer = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$alt('Elm logo'),
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href('https://github.com/EvanPiro/elmdevs.com')
						]),
					_List_fromArray(
						[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$href('/past-events')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Past Events')
									]))
							])),
						A2(
						$elm$html$Html$li,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$href('/term-of-use')
									]),
								_List_fromArray(
									[
...
_Platform_export({'Page':{'init':$author$project$Page$main($elm$json$Json$Decode$value)(0)}});}(this));